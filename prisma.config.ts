...
// For Supabase and other pooled Postgres providers:
// - DATABASE_URL = connection pooler (app runtime queries)
...
if (url && !url.startsWith("postgresql://") && !url.startsWith("postgres://")) {
  console.warn(
    `[prisma.config] WARNING: DB URL does not look like PostgreSQL. Got: ${url.slice(0, 20)}...`
  );
}
